...
- hono/client: `Type instantiation is excessively deep and possibly infinite`
  - server と web で Hono のバージョンが違います。 more: <https://hono.dev/docs/guides/rpc#hono-version-mismatch>
